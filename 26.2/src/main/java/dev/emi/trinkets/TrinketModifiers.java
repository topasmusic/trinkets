...
public class TrinketModifiers {
	...
	public static Multimap<Holder<Attribute>, AttributeModifier> get(Trinket trinket, ItemStack stack, SlotReference slot, LivingEntity entity, Identifier slotIdentifier){
